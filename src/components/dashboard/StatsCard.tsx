import { faCaretUp, faChartLine, faPen } from "@fortawesome/free-solid-svg-icons";
...
interface StatsCardProps {
    activeStat: String;
    setActiveStat: (heading: String) => void;     heading: String;
    numStat: String;
    surge: String;
  }

  
  const StatsCard: React.FC<StatsCardProps> = ({ activeStat, setActiveStat, heading, numStat, surge }) => {
    return (
    <>
    <div
